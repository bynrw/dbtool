...
public class DatabaseManager implements AutoCloseable {
    ...
    public void schliesseVerbindungen() {
        try {
            ...
            Logger.fehler("Fehler beim Schließen der Oracle-Datenbankverbindung", e);
        }
        ...
        try {
            ...
            Logger.fehler("Fehler beim Schließen der PostgreSQL-Datenbankverbindung", e);
        }
    }
}
