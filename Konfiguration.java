...
public class Konfiguration {
    ...
    private static final String KEY_SEQUENZEN_BLACKLIST = "sequenzen.blacklist";
    private static final String KEY_INDIZES_BLACKLIST = "indizes.blacklist";
    private static final String KEY_CONSTRAINTS_BLACKLIST = "constraints.blacklist";
    private static final String KEY_VIEWS_BLACKLIST = "views.blacklist";
    ...
    // Blacklists für verschiedene Objekttypen
    private List<String> sequenzenBlacklist;
    private List<String> indizesBlacklist;
    private List<String> constraintsBlacklist;
    private List<String> viewsBlacklist;
    ...
    public Konfiguration(String dateiPfad) throws IOException {
        ...
        // Blacklists für Datenbankobjekte laden
        initializeObjectBlacklists(properties);
    ...
    /**
     * Initialisiert die Blacklists für verschiedene Objekttypen.
     * 
     * @param properties Die Properties aus der Konfigurationsdatei
     */
    private void initializeObjectBlacklists(Properties properties) {
        this.sequenzenBlacklist = new ArrayList<>();
        String sequenzenBlacklistStr = properties.getProperty(KEY_SEQUENZEN_BLACKLIST, "");
        if (!sequenzenBlacklistStr.isEmpty()) {
            sequenzenBlacklist.addAll(Arrays.asList(sequenzenBlacklistStr.split(",")));
        }
        
        this.indizesBlacklist = new ArrayList<>();
        String indizesBlacklistStr = properties.getProperty(KEY_INDIZES_BLACKLIST, "");
        if (!indizesBlacklistStr.isEmpty()) {
            indizesBlacklist.addAll(Arrays.asList(indizesBlacklistStr.split(",")));
        }
        
        this.constraintsBlacklist = new ArrayList<>();
        String constraintsBlacklistStr = properties.getProperty(KEY_CONSTRAINTS_BLACKLIST, "");
        if (!constraintsBlacklistStr.isEmpty()) {
            constraintsBlacklist.addAll(Arrays.asList(constraintsBlacklistStr.split(",")));
        }
        
        this.viewsBlacklist = new ArrayList<>();
        String viewsBlacklistStr = properties.getProperty(KEY_VIEWS_BLACKLIST, "");
        if (!viewsBlacklistStr.isEmpty()) {
            viewsBlacklist.addAll(Arrays.asList(viewsBlacklistStr.split(",")));
        }
    }
    ...
    // Getter-Methoden für Blacklists
    public List<String> getSequenzenBlacklist() {
        return sequenzenBlacklist != null ? sequenzenBlacklist : new ArrayList<>();
    }
    
    public List<String> getIndizesBlacklist() {
        return indizesBlacklist != null ? indizesBlacklist : new ArrayList<>();
    }
    
    public List<String> getConstraintsBlacklist() {
        return constraintsBlacklist != null ? constraintsBlacklist : new ArrayList<>();
    }
    
    public List<String> getViewsBlacklist() {
        return viewsBlacklist != null ? viewsBlacklist : new ArrayList<>();
    }
    
    // Prüfmethoden für Blacklists
    public boolean sollSequenzMigriert(String sequenzName) {
